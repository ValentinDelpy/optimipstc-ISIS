                ...
                <Container fluid>
                    <Row className={'row-equipe '}>
                        <Col xs="12" xl="6">
                            <Card className={'container-set-interface text-center'}>
                                <CardTitle className={'titre'}>
                                    <a href="/accueil/sections/Parcours/ParcoursEnfantPEC">
                                ...
                                <CardBody className={"TCL-interface"}>
                                    ...
                                    <br/><br/>
                                    <Button className={'button-interface'} color="link" href="/accueil/sections/Parcours/ParcoursEnfantPEC">
                                        Accéder au contenu
                                    </Button><br/>
                                </CardBody>
                            </Card>
                        ...
                        <Col xs="12" xl="6">
                            <Card className={'container-set-interface text-center'}>
                                <CardTitle className={'titre'}>
                                    <a href="/accueil/sections/Parcours/ParcoursEnfantMed">
                                ...
                                <CardBody className={"TCL-interface"}>
                                    ...
                                    <br/>
                                    <Button className={'button-interface'} color="link" href="/accueil/sections/Parcours/ParcoursEnfantMed">
                                        Accéder au contenu
                                    </Button><br/>
                                </CardBody>
                            </Card>
